...
# Inputs
squaremeters = st.number_input("What is the size of the house(m²)?", min_value=10, value=100)
...
basement = st.number_input("What is the size of the basement(m²)?", min_value=0, value=20)
attic = st.number_input("What is the size of the attic(m²)?", min_value=0, value=20)
garage = st.number_input("What is the size of the garage(m²)?", min_value=0, value=20)
citycode = st.number_input("What is the city code?", min_value=1000, max_value=9999, value=5000)
citypartrange = st.slider("What is the city part range?", min_value=1, value=5)
