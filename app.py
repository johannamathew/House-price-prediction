...
st.markdown("""
Please enter the details to predict the house price.
""")
...
#age = st.number_input("House Age (years)", min_value=0, max_value=200, value=5)
...
prev_owners = st.number_input("How many people have previsouly owned the house?", min_value=0, max_value=20, value=1)

# Predict
# features - numberOfRooms, hasYard',hasPool',cityCode',cityPartRange',numPrevOwners',hasStormProtector',hasStorageRoom',
