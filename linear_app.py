...
if st.button("Predict Price"):
    ...
    input_data = input_data[[
        ...
        "cityCode", "cityPartRange", "houseAge", "hasGuestRoom", "hasStormProtector",
        "hasStorageRoom", "isNewBuilt", "hasPool", "hasYard", "numPrevOwners", "made"
    ]]
