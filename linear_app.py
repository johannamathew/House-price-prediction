...
st.markdown("""
Enter the inputs to predict sale price.
""")

# Input
square_meters = st.number_input("Square Meters", min_value=10, max_value=100000, value=100)
num_rooms = st.number_input("Number of Rooms", min_value=1, max_value=100, value=3)
floors = st.number_input("Floors", min_value=1, max_value=100, value=1)
basement = st.number_input("Basement (m²)", min_value=0, max_value=10000, value=20)
attic = st.number_input("Attic (m²)", min_value=0, max_value=10000, value=20)
garage = st.number_input("Garage (m²)", min_value=0, max_value=1000, value=15)
